...
[Issue Tracker](https://github.com/thebigmunch/google-music/issues).
...
See the [commit log](https://github.com/thebigmunch/google-music/commits) for acceptable examples.
